...
<main class="min-h-screen flex items-center justify-center px-4 py-6">
    <div x-data="{ showPass:false }" class="w-full max-w-sm md:max-w-md rounded-3xl border border-gray-200 bg-white shadow-lg overflow-hidden">
            ...
            <form method="POST" action="{{ route('candidate.login.store') }}" class="space-y-3.5">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-xs font-semibold text-[#16A34A] hover:underline">Forgot password?</a>
                    </div>
                ...
                <p class="text-center text-sm text-gray-600 pt-1">
                    ...
                    <a href="{{ route('candidate.register') }}" class="font-semibold text-[#16A34A] hover:underline">
