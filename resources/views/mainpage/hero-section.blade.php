<section class="relative min-h-[90vh] flex items-center justify-center px-4 overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-4xl text-center pt-10 sm:pt-0">
        <h1 class="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white/95 animate-fade-in">
        ...
        <div
            ...
            <div
                class="flex items-center gap-2 flex-1 border border-gray-200 rounded-xl
