...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    ...
    <div class="relative h-52 sm:h-60 lg:h-64">
        ...
        <img
            src="{{ $coverExists ? asset('storage/'.$agency->cover_path) : asset('images/cover.png') }}"
            alt="Agency Cover"
    ...
    <div class="relative px-6 pb-6">
        ...
        <div class="absolute -top-14 left-6">
            ...
            <div class="w-28 h-28 rounded-2xl bg-white border border-gray-200 shadow-lg overflow-hidden flex items-center justify-center">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    @if($agency->verification && $agency->verification->status === 'approved')
                        <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-200 rounded-full">

                            {{-- Check Icon --}}
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm14.03-2.28a.75.75 0 0 0-1.06-1.06l-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5Z" clip-rule="evenodd"/>
                            </svg>
