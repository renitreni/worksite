<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
    ...
    <div class="mt-5 space-y-3 text-sm">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-gray-600">{{ $agency['location'] ?? '—' }}</p>
            </div>
        </div>
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="text-gray-600 break-all">{{ $agency['email'] ?? '—' }}</p>
            </div>
        </div>
    ...
    <div class="mt-6 grid grid-cols-2 gap-3">
        <div class="rounded-2xl bg-gray-50 border border-gray-100 p-4">
            ...
            <p class="mt-1 text-lg font-extrabold text-gray-900">{{ $agency['jobs_available'] ?? 0 }}</p>
        </div>
        <div class="rounded-2xl bg-gray-50 border border-gray-100 p-4">
            <p class="text-xs text-gray-500">Response time</p>
            <p class="mt-1 text-lg font-extrabold text-gray-900">24–48h</p>
        </div>
    </div>
</div>
