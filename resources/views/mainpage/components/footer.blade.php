        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <p class="mt-4 text-white/70 leading-relaxed max-w-md">
                    Connecting job seekers with top recruitment agencies. Find your dream job easily and start your
                    career
            ...
            <!-- Links area:
           Mobile = 2 columns (Quick Links + Support side-by-side)
           Desktop = stays 2 separate columns in the 3-col grid -->
            <div class="md:contents">
                <div class="grid grid-cols-2 gap-8 md:block md:justify-self-center">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-3 text-white/80">
                            ...
                            <li><a href="/search-jobs"
                                    class="hover:text-white transition hover:underline underline-offset-4">Browse
                                    Jobs</a></li>
                            <li><a href="/search-agency"
                                    class="hover:text-white transition hover:underline underline-offset-4">Our
                                    Agencies</a></li>
                            <li><a href="/search-industries"
                                    class="hover:text-white transition hover:underline underline-offset-4">Industries</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="md:hidden">
                        ...
                        <ul class="mt-4 space-y-3 text-white/80">
                            <li><a href="/contact"
                                    class="hover:text-white transition hover:underline underline-offset-4">Contact
                                    Us</a></li>
                            <li><a href="/help-center"
                                    class="hover:text-white transition hover:underline underline-offset-4">Help
                                    Center</a></li>
                            <li><a href="/terms-of-service"
                                    class="hover:text-white transition hover:underline underline-offset-4">Terms of
                                    Service</a></li>
                            <li><a href="/privacy-policy"
                                    class="hover:text-white transition hover:underline underline-offset-4">Privacy
                                    Policy</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="hidden md:block md:justify-self-end md:text-right">
                    ...
                    <ul class="mt-4 space-y-3 text-white/80">
                        ...
                        <li><a href="/help-center"
                                class="hover:text-white transition hover:underline underline-offset-4">Help Center</a>
                        </li>
                        <li><a href="/terms-of-service"
                                class="hover:text-white transition hover:underline underline-offset-4">Terms of
                                Service</a></li>
        ...
        <div class="relative w-full sm:max-w-md">
          ...
          <input type="email" placeholder="Enter your email"
                 class="w-full pl-11 pr-4 py-3 rounded-xl bg-white/10 border border-white/10
                        text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-[#16A34A]">
        </div>
