            ...
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-600">
                            Reject <span class="font-semibold text-slate-900" x-text="selectedName"></span> with a reason.
                        </p>
                    </div>
                    <button type="button" @click="closeAll()"
                        class="inline-flex h-9 w-9 items-center justify-center rounded-lg hover:bg-slate-50 text-slate-500">
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <textarea x-model="rejectReason" rows="4"
                        class="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-800 placeholder:text-slate-400
                ...
                <div class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-3">
                    ...
                    <form method="POST" :action="rejectAction" @submit.prevent="submitReject($event)" class="sm:inline-flex">
                        @csrf
                        @method('PATCH')
    ...
    <div class="relative w-full max-w-md" x-transition.scale.origin.center x-trap.noscroll="suspendOpen">
        <div class="rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-600">
                            Provide a reason to suspend <span class="font-semibold text-slate-900" x-text="selectedName"></span>.
                        </p>
                    </div>
                    <button type="button" @click="closeAll()"
                        class="inline-flex h-9 w-9 items-center justify-center rounded-lg hover:bg-slate-50 text-slate-500">
            ...
            <div class="px-6 py-5 space-y-4">
                <div>
                    <label class="text-xs font-semibold text-slate-700">Reason</label>
                    <textarea x-model="suspendReason" rows="4"
                        class="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-800 placeholder:text-slate-400
                ...
                <div class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-3">
                    ...
                    <form method="POST" :action="suspendAction" @submit.prevent="submitSuspend($event)" class="sm:inline-flex">
                        @csrf
                        @method('PATCH')
            ...
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-600">
                            Update subscription for <span class="font-semibold text-slate-900" x-text="selectedName"></span>.
                        </p>
                    </div>
                    <button type="button" @click="closeAll()"
                        class="inline-flex h-9 w-9 items-center justify-center rounded-lg hover:bg-slate-50 text-slate-500">
        ...
        <div class="rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 overflow-hidden">
            ...
            <div class="px-6 py-5">
                <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    ...
                    {{-- Employer: Approve/Reject if pending and not archived --}}
