      ...
      <div class="mt-4 space-y-3">
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-3 py-3">
            ...
            <button type="button"
              @click="draft.sys.password_require_upper = !draft.sys.password_require_upper; toast('info', draft.sys.password_require_upper ? 'Uppercase required (demo)' : 'Uppercase not required (demo)')"
              class="rounded-full px-3 py-2 text-xs font-semibold ring-1"
          ...
          <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-3 py-3">
            ...
            <button type="button"
              @click="draft.sys.password_require_number = !draft.sys.password_require_number; toast('info', draft.sys.password_require_number ? 'Number required (demo)' : 'Number not required (demo)')"
              class="rounded-full px-3 py-2 text-xs font-semibold ring-1"
          ...
          <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-3 py-3">
            ...
            <button type="button"
              @click="draft.sys.password_require_symbol = !draft.sys.password_require_symbol; toast('info', draft.sys.password_require_symbol ? 'Symbol required (demo)' : 'Symbol not required (demo)')"
              class="rounded-full px-3 py-2 text-xs font-semibold ring-1"
        ...
        <div class="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-3 py-3">
          ...
          <button type="button"
            @click="draft.sys.enforce_2fa_admin = !draft.sys.enforce_2fa_admin; toast('info', draft.sys.enforce_2fa_admin ? '2FA enforced (demo)' : '2FA not enforced (demo)')"
            class="rounded-full px-3 py-2 text-xs font-semibold ring-1"
  ...
  function settingsUI(seed){
    return {
      ...
      init(){
        ...
        // - Admin: allow all except System Settings (demo)
        ...
        this.modules.forEach(m => {
          ...
          this.roles.forEach(r => {
            ...
            else if(r === 'Admin') this.access[m.key][r] = (m.key !== 'mod_settings');
