...
@section('content')
    ...
    <div class="space-y-6" x-data="{ suspendOpen: false, suspendUrl: '', reason: '' }" x-cloak @keydown.escape.window="suspendOpen=false">
            ...
            <form method="GET" action="{{ route('admin.subscriptions.index') }}"
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
                    ...
                    <select name="status"
                        ...
                        <option value="pending_activation" {{ $status === 'pending_activation' ? 'selected' : '' }}>Pending
                        </option>
        ...
        {{-- Suspend Modal --}}
        <div x-show="suspendOpen" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="relative w-full max-w-md">
                <div class="rounded-2xl bg-white shadow-xl ring-1 ring-slate-200 overflow-hidden">
                   ...
                   focus:outline-none focus:ring-2 focus:ring-amber-200"
                            placeholder="e.g., policy violation"></textarea>
