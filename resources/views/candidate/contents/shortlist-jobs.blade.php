        ...
        <div class="rounded-2xl bg-white border border-gray-200 shadow-sm p-5 sm:p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-start gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-3 text-xs text-gray-500">
                            ...
                            <span class="inline-flex items-center gap-1">
                                <i data-lucide="clock-3" class="h-3.5 w-3.5"></i> Posted: 2 days ago
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-2">
                    <button class="rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 transition">
                        Apply Now
                    </button>

                    <button class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 hover:bg-gray-50" title="Remove">
                ...
                <div class="flex items-start gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-3 text-xs text-gray-500">
                            ...
                            <span class="inline-flex items-center gap-1">
                                <i data-lucide="clock-3" class="h-3.5 w-3.5"></i> Posted: 5 days ago
                            </span>
                        </div>
                    </div>
                </div>
