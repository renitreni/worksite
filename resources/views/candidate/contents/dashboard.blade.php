                        ...
                        <div class="flex items-start gap-4 min-w-0">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-2 flex flex-wrap items-center gap-3 text-xs text-gray-500">
                                    <span
                                        class="inline-flex items-center rounded-full px-2 py-0.5 font-semibold border"
            ...
            <div class="p-4 sm:p-6 space-y-6">
                ...
                <div class="rounded-2xl bg-white border border-gray-200 shadow-sm p-5 sm:p-6">
                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
                        <div class="flex items-start gap-4 min-w-0">
                            ...
                            <div class="min-w-0">
                                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900" x-text="selectedJob?.title ?? ''"></h2>
                                <p class="mt-1 text-sm font-semibold text-blue-600" x-text="selectedJob?.company ?? ''"></p>
                                ...
                                <div class="mt-3 flex flex-wrap items-center gap-3">
                                    ...
                                    <span class="text-xs text-gray-500" x-text="'Applied: ' + (selectedJob?.appliedDate ?? '')"></span>
                                </div>
                            </div>
                        </div>

                        <div class="flex items-center gap-3 justify-end">
                            <button class="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 bg-white hover:bg-gray-50" title="Save">
                                <i data-lucide="bookmark" class="h-5 w-5 text-gray-700"></i>
                            </button>
                            <button class="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 bg-white hover:bg-gray-50" title="Share">
                                <i data-lucide="share-2" class="h-5 w-5 text-gray-700"></i>
                            </button>

                            <button
                                type="button"
                                @click="jobModalOpen=false; applyModalOpen=true"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        ...
                        {{-- About Company --}}
                        <div class="rounded-2xl bg-white border border-gray-200 shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900" x-text="'About ' + (selectedJob?.company ?? '')"></h3>
                            ...
                            <div class="mt-4 space-y-4 text-sm text-gray-700">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-0.5" x-text="selectedJob?.companyInfo?.industry ?? ''"></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-0.5" x-text="selectedJob?.companyInfo?.size ?? ''"></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-0.5" x-text="selectedJob?.companyInfo?.founded ?? ''"></p>
                                    </div>
                                </div>

                                <p class="text-gray-600 leading-relaxed" x-text="selectedJob?.companyInfo?.about ?? ''"></p>

                                <button class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50">
                        ...
                        <div class="rounded-2xl bg-white border border-gray-200 shadow-sm p-6">
                            ...
                            <div class="mt-4 space-y-3 text-sm text-gray-700">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-gray-900" x-text="selectedJob?.summary?.experience ?? ''"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-500">Primary Tools</span>
                                    <span class="font-semibold text-gray-900" x-text="selectedJob?.summary?.tools ?? ''"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-500">Team</span>
                                    <span class="font-semibold text-gray-900" x-text="selectedJob?.summary?.team ?? ''"></span>
                                </div>
                            </div>
                        </div>
        ...
        >
            ...
            <div class="px-5 sm:px-6 pb-6 space-y-5">
                <div class="space-y-3">
                    ...
                    <label class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 hover:bg-gray-50 cursor-pointer">
                        <input type="radio" name="resume" class="h-4 w-4 text-emerald-600" checked>
                        <span class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-red-50 border border-red-100">
                    ...
                    <label class="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 hover:bg-gray-50 cursor-pointer">
                        ...
                        <span class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gray-50 border border-gray-200">
                            <i data-lucide="upload" class="h-5 w-5 text-gray-700"></i>
                        </span>
                        <span class="min-w-0">
                            <span class="block text-sm font-semibold text-gray-900 truncate">Upload a different resume</span>
                ...
                <div class="space-y-2">
                    ...
                    ></textarea>
                    <p class="text-xs text-gray-500">A well-written cover letter can help you stand out from other candidates</p>
                </div>
