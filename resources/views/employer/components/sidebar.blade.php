@php
    ...
    $items = [
        [
            ...
            'active' => $is('employer/dashboard'),
        ],
        [
            'label' => 'Company Profile',
            'icon' => 'user',
            'href' => url('/employer/company-profile'),
            'active' => $is('employer/company-profile'),
        ],
        [
            'label' => 'Job Postings',
            'icon' => 'briefcase',
...
<aside x-data="{ openDropdown: null }"
    class="hidden lg:flex lg:fixed lg:inset-y-0 lg:w-64 lg:flex-col bg-white border-r border-gray-200">
