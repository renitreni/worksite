...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-semibold text-gray-900">All Applicants</h1>
    <button
        type="button"
        ...
        @click="alert('Frontend-only: Export Applicants')"
    >
...
<div class="overflow-x-auto bg-white rounded-xl shadow border border-gray-200">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="divide-y divide-gray-200">
            {{-- Dummy applicants --}}
            @foreach(range(1,8) as $applicant)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">applicant{{ $applicant }}@example.com</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">+63 {{ rand(900000000, 999999999) }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex rounded-full bg-emerald-100 px-2 py-1 text-xs font-semibold text-emerald-700">New</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center flex justify-center gap-2">
                        ...
                        <button class="text-green-600 hover:underline" @click="alert('Frontend-only: Shortlist Applicant')">Shortlist</button>
                        <button class="text-red-600 hover:underline" @click="alert('Frontend-only: Reject Applicant')">Reject</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
