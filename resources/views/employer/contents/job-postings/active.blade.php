            ...
            <table class="w-full table-fixed divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th class="w-[10%] px-6 py-4 text-left text-xs font-semibold text-slate-600 uppercase">Applicants
                        </th>
                        <th class="w-[10%] px-6 py-4 text-left text-xs font-semibold text-slate-600 uppercase">Status</th>
                        <th class="w-[20%] px-6 py-4 text-center text-xs font-semibold text-slate-600 uppercase">Actions
                        </th>
                    </tr>
                </thead>
                ...
                <tbody class="divide-y divide-slate-200">
                    @forelse($jobs as $job)
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-5">
                                <span
                                    class="inline-flex items-center justify-center rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-slate-500">Create your first job posting to start receiving
                                    applications.</p>
