                ...
                <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" min="0" name="min_experience_years" id="min_experience_years"
                                    ...
                                    class="mt-2 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                @error('min_experience_years') <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="salary_currency"
                                    class="block text-sm font-medium text-slate-700">Currency</label>
                                <div class="mt-2 relative">
                                    {{-- Modern icon (money) --}}
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            @error('additional_information') <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="principal_employer" id="principal_employer"
                                    ...
                                    class="mt-2 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                @error('principal_employer') <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="dmw_registration_no" id="dmw_registration_no"
                                    ...
                                    class="mt-2 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                @error('dmw_registration_no') <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>

                        <div>
                            <label for="principal_employer_address"
                                class="block text-sm font-medium text-slate-700">Principal /
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="placement_fee_currency"
                                    class="block text-sm font-medium text-slate-700">Placement
                                    Fee Currency</label>
                                <div class="mt-2 relative">
                                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500"
                                        aria-hidden="true">
